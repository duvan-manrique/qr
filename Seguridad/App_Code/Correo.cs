...
public class Correo
{
    ...
    public void enviarCorreoMulta(String correoDestino, String mensaje)
    {

        try
        {
            var Emailtemplate = new System.IO.StreamReader(AppDomain.CurrentDomain.BaseDirectory.Insert(AppDomain.CurrentDomain.BaseDirectory.Length, "Plantilla\\mailerm.html"));
            var strBody = string.Format(Emailtemplate.ReadToEnd(), "");
            Emailtemplate.Close(); Emailtemplate.Dispose(); Emailtemplate = null;
            ...
            //Aquí ponemos el asunto del correo
            mail.Subject = "multa ucundinamarca";
            //Aquí ponemos el mensaje que incluirá el correo
            mail.Body = strBody;
